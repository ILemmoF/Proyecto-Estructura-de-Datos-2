...
public class InterfazPrincipal extends javax.swing.JFrame {
    ...
    private void buttonPedidoMouseClicked(java.awt.event.MouseEvent evt) {//GEN-FIRST:event_buttonPedidoMouseClicked
        ...
        if (cbAlgoritmo.getSelectedItem().toString().equalsIgnoreCase("Floyd-Warshall")){
            ...
            stringPedido = null;
            JOptionPane.showMessageDialog(null, "El metodo Dijkstra podria no funcionar perfectamente, sin embargo esta el codigo :(");
            ...
            while (listaNodosDijkstra.quedanAlmacenesSinVisitar()){
                ...
                JOptionPane.showMessageDialog(null, listaNodosDijkstra.showNodes());
            }
            for (int i = 0; i < listaPedido.size; i++) {
                ListW inW = new ListW();
                VisitedWarehousesList shortP = new VisitedWarehousesList();
                inW = inW.getWarehouses(listaPedido.getNode(i).info.name, menuInicial.warehouseList);
